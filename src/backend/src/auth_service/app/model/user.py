...
from sqlalchemy import UUID, CheckConstraint, Column, Integer, String, LargeBinary
...
class UserModel(Base):
  ...
  role      = Column(String(50), CheckConstraint("role IN ('USER', 'MODERATOR', 'ADMIN')"), default='USER', nullable=False)
